...
public class SteamBottleItem extends FHBaseItem implements IHeatingEquipment, ITempAdjustFood, EnergyHelper.IIEEnergyItem {
    ...
    public void appendHoverText(ItemStack stack, Level worldIn, List<Component> tooltip, TooltipFlag flagIn) {
        ...
        tooltip.add(GuiUtils.translateTooltip("meme.steam_bottle").withStyle(ChatFormatting.GRAY));
        tooltip.add(GuiUtils.translateTooltip("steam_stored", stored).withStyle(ChatFormatting.GOLD));
    }
