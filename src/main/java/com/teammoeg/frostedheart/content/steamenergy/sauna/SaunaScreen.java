...
public class SaunaScreen extends IEContainerScreen<SaunaContainer> {
    ...
    protected void renderBg(PoseStack matrixStack, float partialTicks, int x, int y) {
        ...
        if (powerFraction < 0.25) {
            clock1.blit(mc.gui, matrixStack, leftPos, topPos, clockPos);
        }
        else if (powerFraction < 0.5) {
            clock2.blit(mc.gui, matrixStack, leftPos, topPos, clockPos);
        }
        else if (powerFraction < 0.75) {
            clock3.blit(mc.gui, matrixStack, leftPos, topPos, clockPos);
        }
        else {
            clock4.blit(mc.gui, matrixStack, leftPos, topPos, clockPos);
        }
        ...
        if (tile.isWorking()) {
            ...
            if (effect != null) {
                ...
                flame1.blit(mc.gui, matrixStack, leftPos, topPos, flamePos);
            }
        }
    }
