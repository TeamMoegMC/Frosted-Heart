...
public class ResearchToast implements IToast {
    ...
    public IToast.Visibility render(MatrixStack matrixStack, ToastGui gui, long time) {
        ...
        if (r != null) {
            ...
            int i = 16776960;
            if (list.size() == 1) {
                gui.getMinecraft().font.draw(matrixStack, GuiUtils.translateMessage("toast.research_complete"), 30.0F, 7.0F, i | -16777216);
                ...
                if (time < 1500L) {
                    ...
                    gui.getMinecraft().font.draw(matrixStack, GuiUtils.translateMessage("toast.research_complete"), 30.0F, 11.0F, i | k);
                } else {
