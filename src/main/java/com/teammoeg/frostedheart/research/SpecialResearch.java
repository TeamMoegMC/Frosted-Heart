...
public class SpecialResearch {
    ...
    public static void register(Class<? extends Research> cls,String type,BiFunction<String,JsonObject,Research> json,Function<FriendlyByteBuf,Research> packet) {
    	registry.register(cls, type, json, packet);
    }
    private SpecialResearch() {
    }
    public static void writeId(Research e,FriendlyByteBuf pb) {
    ...
    public static Research deserialize(FriendlyByteBuf data) {
